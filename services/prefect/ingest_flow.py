...
def upsert_csv(table: str, csv_path: str, pk_cols: list[str]):
    ...
    # Conversion en booléen des colonnes pertinentes si elles existent
...
def validate_with_ge(table: str):
    ...
    if table == "users":
        gdf.expect_table_columns_to_match_set([
            "user_id", "signup_date", "user_gender",
            "user_is_senior", "has_family", "has_dependents"
        ])
        ...
        # Bornes raisonnables : agrégats >= 0
