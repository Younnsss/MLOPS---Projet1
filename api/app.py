...
def get_features(user_id: str):
    ...
    # On enlève "user_id" si Feast le renvoie, et on simplifie en scalaires
    feature_dict.pop("user_id", None)
    simple = {name.split(":")[-1]: values[0] for name, values in feature_dict.items()}
